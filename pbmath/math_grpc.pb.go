...
type MathServiceClient interface {
	// Unary RPC
	Add(ctx context.Context, in *Num, opts ...grpc.CallOption) (*Num, error)
}
...
type MathServiceServer interface {
	// Unary RPC
	Add(context.Context, *Num) (*Num, error)
...
func (UnimplementedMathServiceServer) Add(context.Context, *Num) (*Num, error) {
...
var MathService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protobuffer-files/math.proto",
}
